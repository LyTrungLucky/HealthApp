...
import styles from "../../styles/screens/Profile/ProfileStyles";
    ...
    return (
        <View style={styles.profileContainer}>
            <View style={styles.profileHeader}>
                <Text style={styles.profileHeaderTitle}>Ẩ Sơ</Text>
            </View>
            ...
            <ScrollView style={styles.profileContent}>
                <View style={styles.profileUserCard}>
                    ...
                    <Text style={styles.profileUserRole}>{getRoleLabel(user?.role)}</Text>
                    <Text style={styles.profileUserEmail}>{user?.email}</Text>
                </View>

                <View style={styles.profileSection}>
                    <Text style={styles.profileSectionTitle}>Sức khỏe</Text>
